...
bash < <(curl "http://mark-gilbert-co-uk.s3-website-eu-west-1.amazonaws.com/CentOS-Base.repo" --output ~/etc/yum.repos.d/CentOS-Base.repo)

bash < <(curl "http://mark-gilbert-co-uk.s3-website-eu-west-1.amazonaws.com/epel.repo" --output ~/etc/yum.repos.d/epel.repo)
